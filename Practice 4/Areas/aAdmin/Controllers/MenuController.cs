...
namespace Practice_4.Areas.Admin.Controllers
{
    ...
    public class MenuController : Controller
    {
        ...
        public async Task<IActionResult> Manage(EditDishesVM EditDishesVM,int id)
        {
            ...
            var existproduct = await _db.Products.FirstOrDefaultAsync(p => p.Name == EditDishesVM.Name);
            ...
            TempData["Success"] = "Dish has changed successfully!";
        ...
        {
            editDishesVM.Restaurants = await _db.Restaurants.ToListAsync();
            if (editDishesVM.Photo == null)
            {
            ...
            await _db.SaveChangesAsync();
            TempData["Success"] = "Dish has added successfully!";
            return RedirectToAction("List", "Menu");
        }
